...
def get_menu_items(restaurant_id: int, page_no: int = 0, limit: int = 100, db: Session = Depends(get_db)):
    return MenuItemService.get_menu_items(db, restaurant_id, page_no, limit)
